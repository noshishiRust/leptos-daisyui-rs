...
pub fn ThemeControllerDemo() -> impl IntoView {
    ...
    view! {
        <div class="space-y-6">
            ...
            <div class="space-y-4">
                <h2 class="text-xl font-semibold">"Current Theme: " {move || current_theme.get()}</h2>
                
                <h2 class="text-xl font-semibold">"Toggle Themes"</h2>
                <div class="flex gap-2">
                    <ThemeController theme_name="light" checked=Signal::derive(move || current_theme.get() == "light") />
                    <span class="text-sm self-center">"Light"</span>
                    
                    <ThemeController theme_name="dark" checked=Signal::derive(move || current_theme.get() == "dark") />
                ...
                <div class="dropdown">
                    <div tabindex="0" role="button" class="btn m-1">
                        ...
                        <svg width="12" height="12" class="inline-block h-2 w-2 fill-current opacity-60" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2048 2048">
                    ...
                    <Card class="bg-base-100 shadow-xl">
                        <CardBody>
                            ...
                            <div class="card-actions justify-end">
                                <Button color=Signal::derive(|| ButtonColor::Primary)>"Primary"</Button>
                                <Button color=Signal::derive(|| ButtonColor::Secondary)>"Secondary"</Button>
                            </div>
                        </CardBody>
                    </Card>
                ...
                <label class="swap swap-rotate">
                    <input 
                        ...
                        on:change=move |ev| {
                            ...
                            set_current_theme.set(if checked { "dark".to_string() } else { "light".to_string() });
                        }
                    />
