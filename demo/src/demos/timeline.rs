                    ...
                    <li>
                        ...
                        <div class="timeline-middle">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.236 4.53L8.53 10.347a.75.75 0 00-1.06 1.061l1.5 1.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" />
                            </svg>
                        </div>
                            ...
                            <li>
                                ...
                                <div class="timeline-middle">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="text-warning w-5 h-5">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm-3.536-1.757a.75.75 0 001.05.143l1.486-.992a.75.75 0 000-1.394L7.486 7.607a.75.75 0 00-1.05.143A5.5 5.5 0 0010 4.5c.414 0 .828.046 1.23.134a.75.75 0 10.54-1.402A7 7 0 1010 4.5z" clip-rule="evenodd" />
                                    </svg>
                                </div>
                                <div class="timeline-end timeline-box">
                        ...
                        <ul class="timeline timeline-vertical">
                                ...
                                <div class="timeline-middle">
                                    <div class="avatar">
                                        <div class="w-10 rounded-full bg-white/20">
                                            <img src="https://picsum.photos/40/40?random=5" alt="University" />
                                        </div>
                                    </div>
                                </div>
                                <div class="timeline-end timeline-box bg-white/10 border-white/20">
                                    <div class="text-lg font-black text-white">"Computer Science Degree"</div>
                                    <p class="text-indigo-100">"Graduated with honors from State University"</p>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="timeline-middle">
                                    <div class="avatar">
                                        <div class="w-10 rounded-full bg-white/20">
                                            <img src="https://picsum.photos/40/40?random=6" alt="Company" />
                                        </div>
                                    </div>
                                </div>
                                <div class="timeline-end timeline-box bg-white/10 border-white/20">
                                    <div class="text-lg font-black text-white">"Junior Developer"</div>
                                    <p class="text-indigo-100">"Started at TechCorp, working on React applications"</p>
                                </div>
                                <hr class="bg-white/20"/>
                            </li>
                            <li>
                                ...
                                <div class="timeline-middle">
                                    <div class="avatar">
                                        <div class="w-10 rounded-full bg-white/20">
                                            <img src="https://picsum.photos/40/40?random=7" alt="Promotion" />
                                        </div>
                                    </div>
                                </div>
                                <div class="timeline-end timeline-box bg-white/10 border-white/20">
                                    <div class="text-lg font-black text-white">"Senior Developer"</div>
                                    <p class="text-indigo-100">"Promoted to lead the frontend team"</p>
                                </div>
                                <hr class="bg-white/20"/>
                            </li>
                            <li>
                                ...
                                <div class="timeline-middle">
                                    <div class="avatar">
                                        <div class="w-10 rounded-full bg-white/20">
                                            <img src="https://picsum.photos/40/40?random=8" alt="Current" />
                                        </div>
                                    </div>
                                </div>
                                <div class="timeline-end timeline-box bg-white/10 border-white/20">
                                    <div class="text-lg font-black text-white">"Tech Lead"</div>
                                    <p class="text-indigo-100">"Leading architecture decisions and mentoring junior developers"</p>
                                </div>
                            </li>
                        </ul>
                    </CardBody>
                ...
                <ul class="timeline timeline-vertical">
                    <li>
                        <div class="timeline-start timeline-box bg-success text-success-content">
                            <div class="flex items-center gap-2">
                                <Badge color=Signal::derive(|| BadgeColor::Success) size=Signal::derive(|| BadgeSize::Sm)>
                                    "✓ Complete"
                                </Badge>
                    ...
                    <li>
                        ...
                        <div class="timeline-end timeline-box bg-warning text-warning-content">
                            <div class="flex items-center gap-2">
                                <Badge color=Signal::derive(|| BadgeColor::Warning) size=Signal::derive(|| BadgeSize::Sm)>
                                    "⚡ In Progress"
                                </Badge>
                    ...
                    <li>
                        ...
                        <div class="timeline-middle">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="text-base-300 w-5 h-5">
                    ...
                    <CardBody>
                        ...
                        <ul class="timeline timeline-vertical">
                            <li>
                                <div class="timeline-start">
                                    <div class="avatar">
                                        <div class="w-10 rounded-full">
                                            <img src="https://picsum.photos/40/40?random=10" alt="User" />
                                        </div>
                                    </div>
                                </div>
                                <div class="timeline-middle">
                                ...
                                <div class="timeline-end timeline-box">
                                    <div class="font-semibold">"John Doe commented on your post"</div>
                            ...
                            <li>
                                ...
                                <div class="timeline-start">
                                    <div class="avatar">
                                        <div class="w-10 rounded-full">
                                            <img src="https://picsum.photos/40/40?random=11" alt="User" />
                                        </div>
                                    </div>
                                </div>
                                <div class="timeline-middle">
                            ...
                            <li>
                                ...
                                <div class="timeline-start">
                                    <div class="avatar">
                                        <div class="w-10 rounded-full">
                                            <img src="https://picsum.photos/40/40?random=12" alt="User" />
                                        </div>
                                    </div>
                                </div>
                                <div class="timeline-middle">
