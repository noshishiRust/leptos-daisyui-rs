            ...
            <div class="space-y-8">
                ...
                <div class="hero min-h-screen bg-base-200">
                    <div class="hero-content text-center">
                        <div class="max-w-md">
                            ...
                            <Button color=Signal::derive(|| ButtonColor::Primary)>"Get Started"</Button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                            <div class="card-body">
                                ...
                                <div class="form-control mt-6">
                                    <Button color=Signal::derive(|| ButtonColor::Primary)>"Login"</Button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="hero min-h-screen bg-base-200">
                    <div class="hero-content flex-col lg:flex-row">
                        <img src="https://picsum.photos/400/600?random=2" class="max-w-sm rounded-lg shadow-2xl" alt="Hero illustration" />
                        <div>
                ...
                >
                    ...
                    <div class="hero-content text-center text-neutral-content">
                        <div class="max-w-md bg-black bg-opacity-20 backdrop-blur-sm p-8 rounded-2xl">
                            ...
                            <p class="mb-5">"Modern glassmorphism design with backdrop blur effect. Perfect for creating stunning landing pages."</p>
                            <div class="flex gap-2 justify-center">
                                <Button style=Signal::derive(|| ButtonStyle::Outline) class="glass">"Learn More"</Button>
                                <Button color=Signal::derive(|| ButtonColor::Primary) class="glass">"Get Started"</Button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="hero-content text-center text-white">
                        <div class="max-w-2xl">
                            <div class="mb-8">
                                ...
                                <p class="text-xl opacity-90">"Build beautiful, reactive user interfaces with Rust and daisyUI components"</p>
                            </div>
                            
                            <div class="flex flex-wrap gap-4 justify-center mb-8">
                                <Badge color=Signal::derive(|| BadgeColor::Accent) class="badge-lg">"Type Safe"</Badge>
                                <Badge color=Signal::derive(|| BadgeColor::Success) class="badge-lg">"Reactive"</Badge>
                                <Badge color=Signal::derive(|| BadgeColor::Info) class="badge-lg">"Fast"</Badge>
                                <Badge color=Signal::derive(|| BadgeColor::Warning) class="badge-lg">"Modern"</Badge>
                            </div>
                ...
                <div class="hero min-h-96 bg-base-100">
                    <div class="hero-content text-center">
                        <div class="max-w-lg">
                            ...
                            <p class="py-4 text-base-content/70">"Sometimes less is more. A minimalist approach to hero sections."</p>
                            <div class="flex gap-2 justify-center">
                                <Button style=Signal::derive(|| ButtonStyle::Ghost)>"Learn More"</Button>
                                <Button color=Signal::derive(|| ButtonColor::Primary)>"Contact"</Button>
                            </div>
                        </div>
                    </div>
                </div>
