            ...
            <div class="space-y-4">
                ...
                <div class="carousel w-full">
                    <div id="slide1" class="carousel-item relative w-full">
                        <img src="https://picsum.photos/800/400?random=1" class="w-full" alt="Slide 1" />
                    ...
                    <div id="slide2" class="carousel-item relative w-full">
                        <img src="https://picsum.photos/800/400?random=2" class="w-full" alt="Slide 2" />
                        <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    ...
                    <div id="slide3" class="carousel-item relative w-full">
                        <img src="https://picsum.photos/800/400?random=3" class="w-full" alt="Slide 3" />
                        <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                            <a href="#slide2" class="btn btn-circle">"‹"</a>
                            <a href="#slide4" class="btn btn-circle">"›"</a>
                        </div>
                    ...
                    <div id="slide4" class="carousel-item relative w-full">
                        <img src="https://picsum.photos/800/400?random=4" class="w-full" alt="Slide 4" />
                        <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                            <a href="#slide3" class="btn btn-circle">"‹"</a>
                            <a href="#slide1" class="btn btn-circle">"›"</a>
                        </div>
                ...
                <div class="carousel w-full">
                    <div id="item1" class="carousel-item w-full">
                        <img src="https://picsum.photos/800/300?random=16" class="w-full" alt="Item 1" />
                    </div>
                    <div id="item2" class="carousel-item w-full">
                        <img src="https://picsum.photos/800/300?random=17" class="w-full" alt="Item 2" />
                    </div>
                    <div id="item3" class="carousel-item w-full">
                        <img src="https://picsum.photos/800/300?random=18" class="w-full" alt="Item 3" />
                    </div>
                    <div id="item4" class="carousel-item w-full">
                        <img src="https://picsum.photos/800/300?random=19" class="w-full" alt="Item 4" />
                    </div>
                </div>
