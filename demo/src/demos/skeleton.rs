                        ...
                        <CardBody>
                            {move || if loading.get() {
                                ...
                                view! {
                                    <div class="flex items-center gap-4 mb-4">
                                        <div class="avatar">
                                            <div class="w-12 rounded-full">
                                                <img src="https://picsum.photos/48/48?random=1" alt="Avatar" />
                                            </div>
                                        </div>
                                        <div>
                                    ...
                                    <p class="mb-4">"This is the actual content that appears after loading is complete. The skeleton was just a placeholder to show the structure while data was being fetched."</p>
