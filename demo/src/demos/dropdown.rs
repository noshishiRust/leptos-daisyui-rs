            ...
            <div class="space-y-4">
                ...
                <div class="flex flex-wrap gap-4">
                    <div class="dropdown">
                        ...
                        <ul tabindex="0" class="dropdown-content dropdown-top menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
                            <li><a>"Item 1"</a></li>
                            <li><a>"Item 2"</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="dropdown dropdown-left">
                        <div tabindex="0" role="button" class="btn m-1">"Left"</div>
                        <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
                            <li><a>"Item 1"</a></li>
                            <li><a>"Item 2"</a></li>
                        </ul>
                    ...
                    <div class="dropdown dropdown-right">
                        <div tabindex="0" role="button" class="btn m-1">"Right"</div>
                        <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
                            <li><a>"Item 1"</a></li>
                            <li><a>"Item 2"</a></li>
                        </ul>
