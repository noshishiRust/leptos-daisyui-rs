    ...
    view! {
        <div class="space-y-6">
            ...
            <p class="text-base-content/70">
                "Rating component allows users to rate something"
            </p>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-sm">
                        {move || format!("{}/5 stars", rating1.get())}
                    </span>
                </div>
                ...
                <div class="rating">
                    ...
                    <input type="radio" name="rating-7" class="mask mask-heart bg-red-400" checked />
                    <input type="radio" name="rating-7" class="mask mask-heart bg-red-400" />
                    <input type="radio" name="rating-7" class="mask mask-heart bg-red-400" />
                    <input type="radio" name="rating-7" class="mask mask-heart bg-red-400" />
                </div>
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <div class="rating">
                            <input type="radio" name="rating-8" class="mask mask-circle bg-blue-400" />
                            <input type="radio" name="rating-8" class="mask mask-circle bg-blue-400" />
                            <input type="radio" name="rating-8" class="mask mask-circle bg-blue-400" checked />
                            <input type="radio" name="rating-8" class="mask mask-circle bg-blue-400" />
                            <input type="radio" name="rating-8" class="mask mask-circle bg-blue-400" />
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="rating">
                            <input type="radio" name="rating-9" class="mask mask-triangle bg-purple-400" />
                            <input type="radio" name="rating-9" class="mask mask-triangle bg-purple-400" />
                            <input type="radio" name="rating-9" class="mask mask-triangle bg-purple-400" />
                            <input type="radio" name="rating-9" class="mask mask-triangle bg-purple-400" checked />
                            <input type="radio" name="rating-9" class="mask mask-triangle bg-purple-400" />
                        </div>
                    </div>
                </div>
                ...
                <div class="rating">
                    <input type="radio" name="rating-disabled" class="mask mask-star-2 bg-gray-300" disabled />
                    <input type="radio" name="rating-disabled" class="mask mask-star-2 bg-gray-300" disabled />
                    <input type="radio" name="rating-disabled" class="mask mask-star-2 bg-gray-300" disabled checked />
                    <input type="radio" name="rating-disabled" class="mask mask-star-2 bg-gray-300" disabled />
                    <input type="radio" name="rating-disabled" class="mask mask-star-2 bg-gray-300" disabled />
                </div>
            </div>
