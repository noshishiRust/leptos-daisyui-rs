use crate::theme::{ThemeConfiguration, ThemeMetadata, ThemeOverrides, ColorOverrides};
        ...
        (
            ...
            ThemeConfiguration {
                ...
                metadata: Some(ThemeMetadata {
                    ...
                    tags: Some(vec!["blue".to_string(), "ocean".to_string(), "calm".to_string()]),
                    ..Default::default()
                }),
            },
        ),
        (
            ...
            ThemeConfiguration {
                ...
                metadata: Some(ThemeMetadata {
                    ...
                    author: Some("leptos-daisyui-rs".to_string()),
                    version: Some("1.0.0".to_string()),
                    tags: Some(vec!["green".to_string(), "nature".to_string(), "forest".to_string()]),
                    ..Default::default()
                }),
            },
        ),
        (
            ...
            ThemeConfiguration {
                ...
                metadata: Some(ThemeMetadata {
                    ...
                    author: Some("leptos-daisyui-rs".to_string()),
                    version: Some("1.0.0".to_string()),
                    tags: Some(vec!["orange".to_string(), "warm".to_string(), "sunset".to_string()]),
                    ..Default::default()
                }),
            },
        ),
        (
            ...
            ThemeConfiguration {
                ...
                metadata: Some(ThemeMetadata {
                    ...
                    author: Some("leptos-daisyui-rs".to_string()),
                    version: Some("1.0.0".to_string()),
                    tags: Some(vec!["purple".to_string(), "dark".to_string(), "night".to_string()]),
                    ..Default::default()
                }),
            },
        ),
        (
            ...
            ThemeConfiguration {
                ...
                metadata: Some(ThemeMetadata {
                    ...
                    author: Some("leptos-daisyui-rs".to_string()),
                    version: Some("1.0.0".to_string()),
                    tags: Some(vec!["pink".to_string(), "soft".to_string(), "spring".to_string()]),
                    ..Default::default()
                }),
            },
        ),
        (
            ...
            ThemeConfiguration {
                ...
                metadata: Some(ThemeMetadata {
                    ...
                    author: Some("leptos-daisyui-rs".to_string()),
                    version: Some("1.0.0".to_string()),
                    tags: Some(vec!["blue".to_string(), "professional".to_string(), "corporate".to_string()]),
                    ..Default::default()
                }),
            },
        ),
